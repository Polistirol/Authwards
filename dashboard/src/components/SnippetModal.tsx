    ...
    <div className="mt-4">
      <div className="flex items-center justify-between gap-2">
        ...
        <button
          type="button"
          onClick={onCopy}
          className="rounded-md border border-[#2a2d3a] bg-white/5 px-2 py-1 text-xs text-[#6ee7b7] hover:bg-white/10"
        >
          {copied ? "Copiato ✓" : "Copia"}
        </button>
      </div>
      <pre className="mt-2 max-h-64 overflow-auto rounded-lg border border-[#2a2d3a] bg-[#0a0b0f] p-3 font-mono text-xs leading-relaxed text-slate-200">
        {code}
      </pre>
    </div>
  );
  ...
  return (
    ...
    >
      <div
        ...
        className="welcome-modal-enter max-h-[min(92vh,900px)] w-full max-w-[640px] overflow-y-auto rounded-2xl border border-[#2a2d3a] bg-[#12131a] shadow-2xl"
          ...
          <div className="mt-4 space-y-3 rounded-xl border border-[#2a2d3a] bg-[#161821] p-4">
            ...
            <div>
              ...
              <div className="relative mt-1 flex items-start gap-2">
                ...
                <button
                  type="button"
                  className="h-10 w-10 shrink-0 rounded-lg border border-[#2a2d3a] bg-white/5 text-lg hover:bg-white/10"
              ...
              {tab === "n8n" ? (
                <div className="mt-4">
                  <h3 className="text-lg font-semibold text-white">
                    {data.snippets.n8n.label}
                  </h3>
                  <p className="mt-1 text-sm text-slate-400">
                    {data.snippets.n8n.description}
                  </p>
                  <pre className="mt-4 max-h-56 overflow-auto rounded-lg border border-[#2a2d3a] bg-[#0a0b0f] p-4 font-mono text-xs leading-relaxed text-slate-200">
                  ...
                  <button
                    ...
                    className="mt-2 text-sm text-[#6ee7b7] underline"
                  >
                  ...
                  <CodeBlock
                    ...
                    onCopy={() =>
                      void copyText("n8n-check", data.snippets.n8n.checkCommand)
                    }
                  />
                  <CodeBlock
                    label="Execute"
                    ...
                    onCopy={() =>
                      void copyText("n8n-exec", data.snippets.n8n.executeCommand)
                    }
                  />
                </div>
              ) : null}
              ...
              {tab === "curl" ? (
                <div className="mt-4">
                  ...
                  <CodeBlock
                    ...
                    onCopy={() =>
                      void copyText("curl-c", data.snippets.curl.check)
                    }
                  />
                  <CodeBlock
                    label="execute"
                    ...
                    onCopy={() =>
                      void copyText("curl-e", data.snippets.curl.execute)
                    }
                  />
                </div>
              ) : null}
              ...
              {tab === "javascript" ? (
                <div className="mt-4">
                  ...
                  <CodeBlock
                    ...
                    copied={copyMain === "js"}
                    onCopy={() =>
                      void copyText("js", data.snippets.javascript.code)
                    }
                  />
                </div>
              ) : null}
